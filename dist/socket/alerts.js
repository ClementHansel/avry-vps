...
exports.registerAlertsHandlers = registerAlertsHandlers;
exports.createAlertBroadcaster = createAlertBroadcaster;
// ─── Constants ─────────────────────────────────────────────────────────────────
 ...
 */
function registerAlertsHandlers(io, socket, alertSystem) {
    // ─── alert:subscribe ─────────────────────────────────────────────────────
    ...
    // ─── alert:history ───────────────────────────────────────────────────────
    socket.on('alert:history', async (payload) => {
        try {
            const history = await alertSystem.getAlertHistory();
 ...
 * ```
 */
function createAlertBroadcaster(io) {
    return (alert) => {
